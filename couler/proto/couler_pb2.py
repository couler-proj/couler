...
StepIO = _reflection.GeneratedProtocolMessageType('StepIO', (_message.Message,), {
  'DESCRIPTOR' : _STEPIO,
  '__module__' : 'proto.couler_pb2'
...
CannedStepSpec = _reflection.GeneratedProtocolMessageType('CannedStepSpec', (_message.Message,), {
...
ConcurrentSteps = _reflection.GeneratedProtocolMessageType('ConcurrentSteps', (_message.Message,), {
...
StepTemplate = _reflection.GeneratedProtocolMessageType('StepTemplate', (_message.Message,), {
