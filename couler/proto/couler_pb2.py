...
_RESOURCESPEC_RESOURCESENTRY = _descriptor.Descriptor(
  name='ResourcesEntry',
  full_name='couler.v1.ResourceSpec.ResourcesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='couler.v1.ResourceSpec.ResourcesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='couler.v1.ResourceSpec.ResourcesEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESOURCESPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resources', full_name='couler.v1.ResourceSpec.resources', index=5,
  ...
  nested_types=[_RESOURCESPEC_RESOURCESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_RESOURCESPEC_RESOURCESENTRY.containing_type = _RESOURCESPEC
_RESOURCESPEC.fields_by_name['resources'].message_type = _RESOURCESPEC_RESOURCESENTRY
...
ResourceSpec = _reflection.GeneratedProtocolMessageType('ResourceSpec', (_message.Message,), dict(
  ...
  ResourcesEntry = _reflection.GeneratedProtocolMessageType('ResourcesEntry', (_message.Message,), dict(
    DESCRIPTOR = _RESOURCESPEC_RESOURCESENTRY,
    __module__ = 'proto.couler_pb2'
    # @@protoc_insertion_point(class_scope:couler.v1.ResourceSpec.ResourcesEntry)
    ))
  ,
...
_sym_db.RegisterMessage(ResourceSpec.ResourcesEntry)
...
_RESOURCESPEC_RESOURCESENTRY._options = None
